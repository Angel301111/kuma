<template>
  ...
  <section class="w-75 mx-auto my-4">
    <div class="my-4 rounded d-flex justify-content-center align-items-center slogan">
      <p class="m-0 text-secondary p-3">
        專業是我們的基礎，質感是我們的堅持，聆聽您的需求是我們的榮幸。
      </p>
    </div>
    <FormForm v-slot="{ errors }">
      <div class="mb-4">
      ...
      <div class="mb-4">
        <label for="address" class="form-label"> 主旨 </label>
        <FieldField
          id="address"
          name="主旨"
          type="text"
      ...
      <div class="mb-5">
        ...
        <textarea name="留言" id="message" class="form-control"></textarea>
      </div>
      <div>
